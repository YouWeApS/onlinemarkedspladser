...
# WARNING: Using `expect { }.not_to raise_error(SpecificErrorClass)` risks false
#          positives, since literally any other error would cause the
...
#          setting: `RSpec::Expectations.configuration.
